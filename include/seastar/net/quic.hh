...
struct quic_connection_config {
    ...
    size_t                      max_send_udp_payload_size           =                  65'527;
    ...
    uint64_t                    initial_max_stream_data_uni         =              1'000'0000;
    ...
    uint64_t                    max_stream_window                   =             16'000'0000;
    uint64_t                    max_connection_window               =             24'000'0000;
};
